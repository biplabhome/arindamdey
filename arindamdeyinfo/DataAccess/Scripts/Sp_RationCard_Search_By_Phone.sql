IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Sp_RationCard_Search_By_Phone]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[Sp_RationCard_Search_By_Phone]
GO 
--EXEC Sp_RationCard_Search_By_Phone 'jayanta98314@gmail.com', '9831125464', '','01/01/1900','12/12/2018'
--EXEC Sp_RationCard_Search_By_Phone 'jayanta98314@gmail.com', '9831125464', '','06/03/2016','12/12/2018'

CREATE PROCEDURE [dbo].[Sp_RationCard_Search_By_Phone]
	@distId VARCHAR(2),
...
WHERE CASE WHEN @searchText= '' THEN 1 ELSE 
		CASE WHEN (C.Mobile_No = @searchText) THEN 1 ELSE 0 END 
	END = 1
