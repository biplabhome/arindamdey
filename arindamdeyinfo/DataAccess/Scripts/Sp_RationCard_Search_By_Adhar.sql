IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Sp_RationCard_Search_By_Adhar]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[Sp_RationCard_Search_By_Adhar]
GO 
--EXEC Sp_RationCard_Search_By_Adhar 1, '268837639528', '','06/03/2016','12/12/2018'
--EXEC Sp_RationCard_Search_By_Adhar 1, '425522186258', '','06/03/2016','12/12/2018'
--EXEC Sp_RationCard_Search_By_Adhar 1, '812155942917', '1','06/03/2016','12/12/2018'
--EXEC Sp_RationCard_Search_By_Adhar 1, '812155942917', '2','06/03/2016','12/12/2018'
--EXEC Sp_RationCard_Search_By_Adhar 1, '','2','01/01/1900','12/12/2018'
--EXEC Sp_RationCard_Search_By_Adhar 1, '','2','06/03/2012','12/12/2019'

CREATE PROCEDURE [dbo].[Sp_RationCard_Search_By_Adhar]
	@distId VARCHAR(2),
...
WHERE CASE WHEN @searchText= '' THEN 1 ELSE 
		CASE WHEN (C.Adhar_No = @searchText) THEN 1 ELSE 0 END 
	END = 1
